...
func try_summon(unit_scene: PackedScene, viewport_position: Vector2, cost: int, card_data: CardData = null, upgrade_level: int = 1, champion: ChampionState = null, logical_id: int = -1) -> Unit:
